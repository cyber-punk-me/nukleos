...
class ApiHelper : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private var apiLazy = lazy { RetrofitApi(getApiUrl()) }
    ...
    private fun getApiUrl(): String {
        ...
        return PreferenceManager.getDefaultSharedPreferences(context).getString(context.getString(R.string.server_address_key), DEFAULT_LOCAL_URL) ?: DEFAULT_LOCAL_URL
    }


    private fun resetRetrofitApi() {
        apiLazy = lazy { RetrofitApi(getApiUrl()) }
    }
